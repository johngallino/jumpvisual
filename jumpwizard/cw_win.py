...
#        user.man_bool = self.manvar.get()
        ...
        user.address = self.address.get()
        user.birthday = self.birthday.get()
        user.faa_num = self.faa_num.get()
        user.emer_name = self.emer_name.get()
        user.emer_relation = self.emer_relation.get()
        user.emer_cell = self.emer_cell.get()
